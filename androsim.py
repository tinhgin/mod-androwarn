...
option_11 = { 'name' : ('-p', '--dump'), 'help' : 'dump smali code of classes have SIMILAR methods and NEW methods', 'action' : 'count' }

options = [option_0, option_1, option_2, option_4, option_5, option_6, option_7, option_8, option_9, option_10, option_11]
